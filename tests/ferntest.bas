   ...
   50
   60 N% = 50
   70 DIM p(2,N%-1), q(2,N%-1), a(2,2), b(2,2), c(2,2), r(2,2), u(2,2)
   80
  ...
  351   a(0,0)=1:a(0,1)=0:a(0,2)=0:a(1,0)=COS(a):a(1,1)=-SIN(a):a(1,2)=0:a(2,0)=0:a(2,1)=SIN(a):a(2,2)=COS(a)
  360   b() = COS(b), 0, SIN(b), 0, 1, 0, -SIN(b), 0, COS(b)
  370   c() = COS(c), -SIN(c), 0, SIN(c), COS(c), 0, 0, 0, 1
  380   REM r() = b() . a() : r() = c() . r()
  381   u() = b() . a()
  382   r() = c() . u()
  385   REM FOR I% = 0 TO 2:PRINT r(0,I%), r(I%,0):NEXT I%
  390
  ...
  440   CLS
  450   FOR I% = 0 TO N%-1
  460     REM z = 1000 / (12 + q(2,I%))
  465     REM PRINT z
  466     PRINT q(0,I%),q(1,I%),q(2,I%)
  470   REM  PLOT q(0,I%)*z, q(1,I%)*z
  475   REM PRINT q(0,I%)*z, q(1,I%)*z
  480   NEXT
  490
