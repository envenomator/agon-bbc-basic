...
1:			RET				; Dummy return for unimplemented functions
...
OSBYTE_86:		PUSH	IX			; Get the system vars in IX
			...
			RES.LIL	0, (IX+sysvar_vdp_pflags)
			VDU	23
			VDU	0
			VDU	vdp_cursor
1:		BIT.LIL	0, (IX+sysvar_vdp_pflags)
...
1:			XOR	A			; Zero terminate the target string
			LD	(DE), A
